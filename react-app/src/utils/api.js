...
export const getArchivedSites = () => call('getArchivedSites')
...
export const unarchiveSite  = (siteId) => call('unarchiveSite', { siteId })
...
export const generatePaymentReceipt = (paymentId) => call('generatePaymentReceipt', { paymentId })
